...
public interface HomePageDataServcie {
	 ...
	 * 用户领取《专属优惠券》
	 */
	ReceiveExclusiveCouponResponse receiveExclusiveCoupon(ReceiveExclusiveCouponRequest request, ReceiveExclusiveCouponResponse response);
	/**
	 ...
	 * 获取优惠券活动表信息
	 */
	GetAdCouponActivityInfosResponse getAdCouponActivityInfos(String activityId, GetAdCouponActivityInfosResponse response);
}
