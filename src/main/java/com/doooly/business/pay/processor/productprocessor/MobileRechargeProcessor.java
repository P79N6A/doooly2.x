 ...
 */
@Component
public class MobileRechargeProcessor implements ProductProcessor {

	protected Logger logger = LoggerFactory.getLogger(MobileRechargeProcessor.class);
	...
	public int getProcessCode() {
		return ProductType.MOBILE_RECHARGE.getCode();	}
