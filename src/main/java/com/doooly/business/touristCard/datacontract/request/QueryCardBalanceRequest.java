 ...
 */
public class QueryCardBalanceRequest extends BaseRequest {
	/** 卡号(11位卡面号) **/
	private String cardno;

	public QueryCardBalanceRequest(JSONObject json) {
		super();
		this.requestType = PropertiesHolder.getProperty("CARD_BALANCE_SERVICE");
